...
//        etLine1.setText("12152073");
//        etLine2.setText("34655708");
//        etLine3.setText("30551728");
//        etLine4.setText("99314702");
    ...
    private List<Integer> mathList(List<Integer> list1, List<Integer> list2, boolean sum) {
        Integer sumList;
        Integer result = 0;
    ...
    public void clickedCalculate() {
        ...
        if (list1.size() == 8 && list2.size() == 8 && list3.size() == 8 && list4.size() == 8){
            list6 = mathList(list1, list2, true);
            list8 = mathList(list3, list4, true);

            list7 = mathList(list1, list2, false);
            list9 = mathList(list3, list4, false);

            list10 = mathList(list6, list9, true);
            list11 = mathList(list7, list8, true);

            joinList1 = joinList(list10, list11);
            joinList2 = joinList(list11, list10);
